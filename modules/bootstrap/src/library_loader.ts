...
namespace __sharpangles {
    export class LibraryLoader {
        ...
        /**
         * Loads all libraries that can be discovered from the root.
        ...
        private _taskMap = new TaskMap<string, Dependency, { [key: string]: Dependency }>((key: string, source: Dependency) => new Task<any>(() => this._loadChildLibrariesAsync(source)));
