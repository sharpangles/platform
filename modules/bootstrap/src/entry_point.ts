...
namespace __sharpangles {
    ...
    export abstract class EntryPoint<TModuleLoaderConfig> {
        constructor(public dependencyPolicy: DependencyPolicy<TModuleLoaderConfig>, features?: Feature | Feature[], public baseUrl: string = '/') {
        ...
        protected createPolyfiller() {
            return new Polyfiller(this.moduleLoader, this.baseUrl);
        }
