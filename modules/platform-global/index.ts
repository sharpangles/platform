...
export { FeatureReference } from './src/features/feature_reference';
export { Feature } from './src/features/feature';

export { AngularPlatformBrowserDynamicFeature } from './src/features/angular/angular_platform_browser_dynamic_feature';
export { AngularPlatformBrowserFeature } from './src/features/angular/angular_platform_browser_feature';
export { AngularPlatformFeature } from './src/features/angular/angular_platform_feature';
export { AngularPlatformServerFeature } from './src/features/angular/angular_platform_server_feature';
export { AngularSystemJSConfigFeature } from './src/features/angular/angular_systemjs_config_feature';
export { AngularTestingBrowserDynamicFeature } from './src/features/angular/angular_testing_browser_dynamic_feature';
export { AngularTestingServerFeature } from './src/features/angular/angular_testing_server_feature';
export { ZoneJSTestingFeature } from './src/features/angular/zonejs_testing_feature';
