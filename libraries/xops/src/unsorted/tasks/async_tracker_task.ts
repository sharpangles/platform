import { CancelPollingTask } from './cancel_polling_task';

/**
 * A process that starts, progresses, and the completes.
 * Completion can be due to success, failure, or cancellation.
 */
export abstract class AsyncTrackerProcess<TProgress = any, TResult = any, TError = any> extends CancelPollingTask<TProgress, TResult, TError> {
