 ...
 */
export abstract class OverridingTracker<TProcess extends TrackerProcess<TProgress, TError> = TrackerProcess<TProgress, TError>, TConfig = any, TConnectState = any, TProgress = any, TError = any> extends MutexTracker<TProcess, TConfig, TConnectState, TProgress, TError> {
